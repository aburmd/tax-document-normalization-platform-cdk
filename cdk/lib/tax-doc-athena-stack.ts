...
export class TaxDocAthenaStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: TaxDocAthenaStackProps) {
    ...
    const tables: Record<string, { columns: glue.CfnTable.ColumnProperty[]; broker: string; section: string }> = {
      ...
      // Fidelity
      fidelity_transactions_1099b:        { columns: COLS_1099B_TXNS, broker: "fidelity", section: "transactions_1099b" },
      fidelity_realized_gain_loss_detail: { columns: COLS_REALIZED_DETAIL, broker: "fidelity", section: "realized_gain_loss_detail" },
      fidelity_realized_gain_loss_summary:{ columns: COLS_REALIZED_SUMMARY, broker: "fidelity", section: "realized_gain_loss_summary" },
      fidelity_dividends_1099div:         { columns: COLS_1099DIV, broker: "fidelity", section: "dividends_1099div" },
      ...
      fidelity_statement_positions:       { columns: COLS_STMT_POSITIONS, broker: "fidelity", section: "positions" },
    };
